...
export const markersLibrary = {
  ...
  Recreation: [
    ...
    { label: "anchorage", pattern: "" },
    { label: "lifepreserver", pattern: "" },
    { label: "marsh", pattern: "" },
    { label: "waterfalls", pattern: "" },
    { label: "peak", pattern: "" },
    { label: "drinking-water", pattern: makiPaths["drinking-water"] },
    { label: "phone", pattern: "" },
    { label: "shower", pattern: "" },
    { label: "firstaidplus", pattern: "" },
    { label: "binoc", pattern: "" },
    { label: "fuel", pattern: makiPaths.fuel },
    { label: "info", pattern: "" },
    { label: "automobile", pattern: "" },
    { label: "4wd", pattern: "" },
    { label: "atv", pattern: "" },
    { label: "snowmobiling", pattern: "" },
    { label: "snowmobiling-no", pattern: "" },
    { label: "gate-side", pattern: "" },
  ],
  Basic: [
