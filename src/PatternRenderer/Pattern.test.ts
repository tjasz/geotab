  ...
  it.each<[string, Pattern]>([
    ...
    [
      ...
      [{
        path: {
          commands: [
            { operator: "M", parameters: [-8, -6] },
            { operator: "M", parameters: [8, 6] },
            { operator: "M", parameters: [-6, 0] },
            { operator: "L", parameters: [0, 4] },
            { operator: "L", parameters: [6, 0] },
            { operator: "L", parameters: [0, -4] },
          ]
        }, offset: 0, interval: 10, type: "F"
      }]
    ],
    [
    ...
    [
      ...
      [{
        path: {
          commands: [
            { operator: "M", parameters: [-12, -12] },
            { operator: "M", parameters: [12, 12] },
            { operator: "M", parameters: [2, 6] },
            { operator: "A", parameters: [2, 2, 0, 1, 0, -2, 6] },
            { operator: "A", parameters: [2, 2, 0, 1, 0, 2, 6] },
            { operator: "M", parameters: [10, 6] },
            { operator: "A", parameters: [2, 2, 0, 1, 0, 6, 6] },
            { operator: "A", parameters: [2, 2, 0, 0, 0, 10, 6] },
          ]
        }, offset: 0, interval: 25, type: "F"
      }]
    ],
  ])(
    "parsePattern(%p)",
